...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--dataset_name', required=True, help='california / covtype')
        ...
        parser.add_argument('--num_workers', type=int, default=4, help='# of num_workers')
...
class AugmentConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--name', required=True)
        parser.add_argument('--dataset', required=True, help='california / covtype')
